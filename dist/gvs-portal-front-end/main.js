...
class EmployeeinfoComponent {
    constructor(router, cookie, cloudantservice, Db2Service, servicenowservice) {
        this.router = router;
        this.cookie = cookie;
        this.cloudantservice = cloudantservice;
